...
global::DripSharp.SqlTrellis.Test.TestUtils.assertSqlCanBeParsedAndDeparsed(statement);
global::DripSharp.SqlTrellis.Test.TestUtils.assertDeparse(new global::DripSharp.SqlTrellis.Statement.Create.Table.CreateTable().withTable(new global::DripSharp.SqlTrellis.Schema.Table("foo")).addIndexes(new global::DripSharp.SqlTrellis.Statement.Create.Table.ExcludeConstraint().withExpression(((global::DripSharp.SqlTrellis.Expression.Operators.Relational.GreaterThan)(((global::DripSharp.SqlTrellis.Expression.Operators.Relational.GreaterThan)(new global::DripSharp.SqlTrellis.Expression.Operators.Relational.GreaterThan().withLeftExpression(new global::DripSharp.SqlTrellis.Schema.Column("col1")))).withRightExpression(new global::DripSharp.SqlTrellis.Expression.LongValue((long)(100))))))).addColumnDefinitions(new global::DripSharp.SqlTrellis.Statement.Create.Table.ColumnDefinition("col1", new global::DripSharp.SqlTrellis.Statement.Create.Table.ColDataType("integer"))), statement);
}
