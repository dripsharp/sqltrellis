...
global::DripSharp.SqlTrellis.Statement.Alter.Alter created = new global::DripSharp.SqlTrellis.Statement.Alter.Alter().withTable(new global::DripSharp.SqlTrellis.Schema.Table("`Author`")).addAlterExpressions(global::DripSharp.Runtime.JavaCompat.SetOf<global::DripSharp.SqlTrellis.Statement.Alter.AlterExpression>(new global::DripSharp.SqlTrellis.Statement.Alter.AlterExpression().withOperation(global::DripSharp.SqlTrellis.Statement.Alter.AlterOperation.ADD).withIndex(new global::DripSharp.SqlTrellis.Statement.Create.Table.CheckConstraint().withName("name_not_empty").withExpression(new global::DripSharp.SqlTrellis.Expression.Operators.Relational.NotEqualsTo().withLeftExpression(new global::DripSharp.SqlTrellis.Schema.Column("`NAME`")).withRightExpression(new global::DripSharp.SqlTrellis.Expression.StringValue())))));
...
global::DripSharp.SqlTrellis.Statement.Statement parsed = global::DripSharp.SqlTrellis.Test.TestUtils.assertSqlCanBeParsedAndDeparsed(statement);
global::DripSharp.SqlTrellis.Statement.Alter.Alter created = new global::DripSharp.SqlTrellis.Statement.Alter.Alter().withUseOnly(true).withTable(new global::DripSharp.SqlTrellis.Schema.Table("categories")).addAlterExpressions(new global::DripSharp.SqlTrellis.Statement.Alter.AlterExpression().withOperation(global::DripSharp.SqlTrellis.Statement.Alter.AlterOperation.ADD).withIndex(new global::DripSharp.SqlTrellis.Statement.Create.Table.NamedConstraint().withName(global::DripSharp.Runtime.JavaCompat.ListOf<string>("pk_categories")).withType("PRIMARY KEY").addColumns(new global::DripSharp.SqlTrellis.Statement.Create.Table.Index.ColumnParams("category_id"))));
global::DripSharp.SqlTrellis.Test.TestUtils.assertDeparse(created, statement);
global::DripSharp.SqlTrellis.Test.TestUtils.assertEqualsObjectTree(parsed, created);
}
