...
global::DripSharp.SqlTrellis.Test.TestUtils.assertSqlCanBeParsedAndDeparsed(statement);
global::DripSharp.SqlTrellis.Test.TestUtils.assertDeparse(new global::DripSharp.SqlTrellis.Statement.Select.PlainSelect().addSelectItem(new global::DripSharp.SqlTrellis.Statement.Select.AllColumns()).withFromItem(new global::DripSharp.SqlTrellis.Schema.Table("mytable")).withWhere(new global::DripSharp.SqlTrellis.Expression.Operators.Conditional.AndExpression().withUseOperator(true).withLeftExpression(new global::DripSharp.SqlTrellis.Expression.Operators.Relational.EqualsTo(new global::DripSharp.SqlTrellis.Expression.LongValue((long)(1)), new global::DripSharp.SqlTrellis.Expression.LongValue((long)(2)))).withRightExpression(new global::DripSharp.SqlTrellis.Expression.Operators.Relational.EqualsTo(new global::DripSharp.SqlTrellis.Expression.LongValue((long)(2)), new global::DripSharp.SqlTrellis.Expression.LongValue((long)(3))))), statement);
}
